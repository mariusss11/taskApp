...
const AuthForm = ({type}:FormType):React.JSX.Element => {
    ...
    return <div className="auth-content">
        ...
        <form onSubmit={handleSubmit(onSubmit)}>
            ...
            {type==="sign-up"&&(<input placeholder="Email" className="form-input" {...register("email", {required:true})} />)}
            <input placeholder="Password" type="password" {...register("password", {required: true, minLength: 6})} className="form-input"/>
